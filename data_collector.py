...
# ── 섹터 키워드 매핑 ─────────────────────────────────────────────────────────
SECTOR_KEYWORDS = {
    "반도체": ["삼성전자", "SK하이닉스", "한미반도체", "리노공업", "HPSP", "이수페타시스",
               "반도체", "HBM", "DRAM", "낸드", "파운드리", "웨이퍼", "칩", "메모리",
               "디스플레이", "OLED", "LCD", "삼성디스플레이", "LG디스플레이"],
    "로봇":   ["현대로보틱스", "두산로보틱스", "레인보우로보틱스", "HD현대",
               "로봇", "자동화", "협동로봇", "AI로봇", "스마트팩토리", "물류자동화"],
    "방산":   ["한화에어로스페이스", "LIG넥스원", "현대로템", "한국항공우주", "KAI",
               "방산", "K방산", "무기", "항공", "우주", "드론", "방위산업", "군수"],
    "조선":   ["HD현대중공업", "삼성중공업", "한화오션", "HD현대미포", "현대삼호",
               "조선", "LNG선", "해양플랜트", "선박", "해운", "컨테이너선", "VLCC"],
    "2차전지":["LG에너지솔루션", "삼성SDI", "SK온", "에코프로", "포스코퓨처엠",
               "엘앤에프", "코스모화학", "천보", "배터리", "2차전지", "전기차", "EV",
               "양극재", "음극재", "전해질", "리튬", "배터리셀"],
    "바이오": ["삼성바이오로직스", "셀트리온", "유한양행", "한미약품", "종근당",
               "녹십자", "대웅제약", "동아에스티", "바이오", "신약", "제약",
               "바이오시밀러", "임상", "FDA", "CDMO", "헬스케어", "의료기기"],
    "플랫폼": ["카카오", "NAVER", "네이버", "쿠팡", "크래프톤", "넷마블", "엔씨소프트",
               "카카오게임즈", "위메이드", "플랫폼", "게임", "IT서비스", "핀테크",
               "이커머스", "광고", "콘텐츠", "OTT", "메타버스"],
    "자동차": ["현대차", "기아", "현대모비스", "한온시스템", "만도",
               "자동차", "완성차", "자율주행", "수소차", "전기차"],
    "금융":   ["삼성생명", "한화생명", "DB손해보험", "삼성화재", "KB금융",
               "신한지주", "하나금융", "우리금융", "카카오뱅크",
               "금융", "은행", "보험", "증권", "카드"],
    "건설":   ["삼성물산", "현대건설", "GS건설", "DL이앤씨", "포스코이앤씨",
               "건설", "부동산", "리츠", "인프라", "주택"],
    "철강":   ["POSCO홀딩스", "현대제철", "동국제강", "세아제강",
               "철강", "철", "금속", "알루미늄", "구리", "소재"],
    "에너지": ["한국전력", "한국가스공사", "SK이노베이션", "에쓰오일", "GS에너지",
               "에너지", "정유", "LNG", "원전", "신재생", "태양광", "풍력"],
}
